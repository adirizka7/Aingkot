  ...
  <ons-template id="tab2.html">
	...
	<form method="post" id="register-form">
      <p style="text-align: center;">
        <div style="text-align: center; margin-top: 30px;">
          <p>
            <ons-input id="email" modifier="underbar" type="email" placeholder="Email" name="email" float></ons-input>
          </p>
          <p>
            <ons-input id="password" modifier="underbar" type="password" name="password" placeholder="Password" float></ons-input>
          </p>
          <p style="margin-top: 30px;">
