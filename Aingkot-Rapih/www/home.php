        ...
        <div class="center">
          About
			...
			<div style="text-align: center;">
				<p><img src="2.jpg" style="width:300px; height: 200px;"></p>
				<p style="font-family:Friday Night Lights">Angkot In Modern Side.</p>
				<p> I-Ngkot adalah sebuah aplikasi yang bertujuan untuk memudahkan para pengguna transportasi umum melalui jasa angkot. Aplikasi ini
					menyediakan berbagai macam rute angkot dan juga penyewaan angkot.</p>
				<p>
			</div>
