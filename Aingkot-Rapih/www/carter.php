        ...
        <div style="text-align: center; margin-top: 30px;">
          <p>
            ...
            <p><ons-input modifier="underbar" name="tujuan" placeholder="destinasi" float required></ons-input></p>
			      ...
			      <p><textarea style="margin:10px;" class="textarea" rows="5" cols="50" placeholder="keterangan" name="komen"></textarea></p>
        </p>
          <p style="margin-top: 30px;">
            <button type="submit" class="button" name="hoy" style="width: 30vw; height: 6vh;" onclick="return confirm('Permintaan Terkirim');">Kirim Carter</button>
          </p>
        </div>
      </p>
  </form>
